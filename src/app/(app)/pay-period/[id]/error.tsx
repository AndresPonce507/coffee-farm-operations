...
/**
 * Route-level error boundary for the /pay-period/[id] dossier.
 *
 * The dossier getters throw when Supabase is unreachable (the free-tier project
 ...
 * trace. An unknown period id is handled by notFound() in the page (a real 404),
 * not here; this boundary is only for read failures.
 */
export default function PayPeriodDossierError({
  error,
  reset,
}: {
