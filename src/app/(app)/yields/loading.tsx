/**
 * /yields — instant route-loading skeleton.
 *
 * Rendered the moment the segment starts loading, swapped for the real board once
 * page.tsx resolves. Mirrors that page's shape — header, a 4-up KPI strip, a grid of
 * yield-factor cards, then the calculator + legend row — so the layout never shifts.
...
export default function YieldsLoading() {
  ...
  return (
    <div className="space-y-6" aria-busy="true" aria-label={t("loading.board")}>
      ...
      {/* KPI strip — 4 tiles in a divided glass card. */}
